...
def predict():
	if request.method == "POST":
		...
		# Evaporation
		evaporation_str = request.form['evaporation']
		...
		if cloud3pm.lower() == 'na':
            # Handle the 'NA' case, for example, by setting a default value or raising an error
			cloud3pm = 0.0  # You can set any default value you prefer
		else:
